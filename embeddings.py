# This code refers code from: wyharveychen/CloserLookFewShot. lmzintgraf/cavia. hoyeoplee/MeLU.
# Creat Time: 2020/12/19 9:48
...
class item(torch.nn.Module):
    def __init__(self, config):
        ...
        self.num_rate = config.num_rate  # [[5],[5],[5],[4]]
        ...
        self.embedding_rate = torch.nn.Embedding(
            num_embeddings=self.num_rate,  # 6
